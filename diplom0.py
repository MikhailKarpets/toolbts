...
#for row in numbers_of_long_life_bug_reports:
#    X_train_long_life_bug_reports = 
...
X_train_all_features, X_test_all_features, y_train, y_test = train_test_split(tfidf_matrix_dense, #SPARSE OR DENSE MATRIX?
                                                    list_of_bug_reports_lifetimes,
                                                    test_size=0.33, random_state=42)

#print(type(X_test_all_features))
#print(len(X_test_all_features[0]))


y_train_10 = to_list_of_lifetimes_after_cutoff(y_train, 10)
y_test_10 = to_list_of_lifetimes_after_cutoff(y_test, 10)

y_train = to_list_of_lifetimes_after_cutoff(y_train, 10)
y_test = to_list_of_lifetimes_after_cutoff(y_test, 10)

print('number of features')
print(len(X_test_all_features[0]))
print(len(X_train_all_features[0]))
...
for num_feat in [50,60,70,80]:
    print('-------------------------------------------------') 
    print('-------------------------------------------------') 
    print('-------------------------------------------------') 
    print('NUM OF FEATURES IS')
    print(num_feat)
    ...
    for key in np.asarray(tf.get_feature_names())[ch2.get_support()]:
        selected_features_numbers_of_col.append((tf.vocabulary_).get(key))
    X_test_50_features = X_test_all_features[:,selected_features_numbers_of_col]
    #print(np.asarray(tf.get_feature_names())[ch2.get_support()])
    #print(len(X_test_50_features))
    #print(X_test_50_features.shape)
    #print(X_test_50_features)
    #print(len(selected_features_numbers_of_col))
